...
void runProof(const char * incollection = "./input/input_files.dat", const char * outfile = "MC_MultEst.root")
{
  TProof::Open("lite://");
  ...
  gProof->Load("MultiplicityEstimators.cxx+g");
  gProof->Load("AliAnalysisTaskHMTFMCMultEst.cxx+g");
